...
class LiveRecording(object):
    ...
    def __init__(self, cause=None, duration=None, format=None, name=None, silence_duration=None, state=None, talking_duration=None, target_uri=None, local_vars_configuration=None):  # noqa: E501
        """LiveRecording - a model defined in OpenAPI"""  # noqa: E501
