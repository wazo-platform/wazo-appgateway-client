...
class EventsApi(object):
    ...
    def events_get_with_http_info(self, app, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('app' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `app` when calling `events_get`")  # noqa: E501
        ...
        if 'subscribe_all' in local_var_params and local_var_params['subscribe_all'] is not None:  # noqa: E501
            query_params.append(('subscribeAll', local_var_params['subscribe_all']))  # noqa: E501
    ...
    def events_user_event_name_post(self, event_name, application, **kwargs):  # noqa: E501
        ...
        :param x_asterisk_id:
        :type x_asterisk_id: str
        :param containers: The \"variables\" key in the body object holds custom key/value pairs to add to the user event. Ex. { \"variables\": { \"key\": \"value\" } }
    ...
    def events_user_event_name_post_with_http_info(self, event_name, application, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('event_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['event_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `event_name` when calling `events_user_event_name_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('application' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `application` when calling `events_user_event_name_post`")  # noqa: E501
        ...
        if 'source' in local_var_params and local_var_params['source'] is not None:  # noqa: E501
            ...
            collection_formats['source'] = 'multi'  # noqa: E501
