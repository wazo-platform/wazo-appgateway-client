...
from wazo_appgateway_client.models.channel_hold_all_of import ChannelHoldAllOf  # noqa: E501
from wazo_appgateway_client.rest import ApiException

class TestChannelHoldAllOf(unittest.TestCase):
    """ChannelHoldAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ChannelHoldAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = wazo_appgateway_client.models.channel_hold_all_of.ChannelHoldAllOf()  # noqa: E501
        if include_optional :
            return ChannelHoldAllOf(
