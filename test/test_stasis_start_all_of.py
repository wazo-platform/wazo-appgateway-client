...
from wazo_appgateway_client.models.stasis_start_all_of import StasisStartAllOf  # noqa: E501
from wazo_appgateway_client.rest import ApiException

class TestStasisStartAllOf(unittest.TestCase):
    """StasisStartAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StasisStartAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = wazo_appgateway_client.models.stasis_start_all_of.StasisStartAllOf()  # noqa: E501
        if include_optional :
            return StasisStartAllOf(
                args = [
                    '0'
                    ], 
