...
from wazo_appgateway_client.models.channel_dialplan import ChannelDialplan  # noqa: E501
from wazo_appgateway_client.rest import ApiException

class TestChannelDialplan(unittest.TestCase):
    """ChannelDialplan unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ChannelDialplan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = wazo_appgateway_client.models.channel_dialplan.ChannelDialplan()  # noqa: E501
        if include_optional :
